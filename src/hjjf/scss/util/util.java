...
public class util {
	...
	public static String getcoursetime(){
		int year=Integer.valueOf(getNowTime().split("-")[0]);
		int month=Integer.valueOf(getNowTime().split("-")[1]);
		if(month>8){
			return year+"—"+(year+1)+"学年 上学期" ;
		}else{
			return (year-1)+"—"+year+"学年 下学期" ;
		}
	}
	...
	*/
	 ...
	 * @throws Exception 异常
	 */
	public static void fileupload(HttpServlet servlet,
