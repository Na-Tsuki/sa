			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="card form" id="form1">
						...
						<br>
						<form action="stu/passup" method="post">
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group">
										<label for="exampleInputPassword1">原密码</label> <input
											type="text" class="form-control" name="student.Password"
											id="Password">
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">新密码</label> <input
											type="text" class="form-control" name="student.NewPassword"
											id="NewPassword">
									</div>
									<div class="form-group">
										<label for="exampleTextarea">确认密码</label> <input
											class="form-control" id="ConPassword" name="student.ConPassword" />
									</div>
