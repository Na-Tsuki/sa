			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="card form" id="form1">
						...
						<br>
						<form action="tea/selfup" method="post">
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group">
										<label for="exampleInputPassword1">性别</label> <input
											type="text" class="form-control" name="teacher.Sex" id="Sex"
											value="<%=tea.getSex()%>">
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">生日</label> <input
											class="form-control" type="date" id="Birth" name="teacher.Birth"
											value="<%=tea.getBirth()%>">
									</div>
									<div class="form-group">
										<label for="exampleTextarea">备注</label> <input
											class="form-control" id="exampleTextarea" name="teacher.Remark"
											value="<%=tea.getRemark()%>" />
									</div>
						...
						<form class="col-md-6" action="tea/execute"
