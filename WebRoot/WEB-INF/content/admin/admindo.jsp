			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="card form" id="form1">
						...
						<br>
						<form id="form" action="adm/add" method="post">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleInputEmail1">管理员编号</label> <input
											type="text" class="form-control" id="AdminID" name="admin.AdminID">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleTextarea">管理员权限</label>
										<textarea class="form-control" id="Role" rows="2" name="admin.Role"></textarea>
									</div>
						...
						success : function(json) {
							...
							for (var i = 0; i < json.length; i++) {
								trhtml += "<tr><th scope = 'row'>" + (i + 1)
										+ "</th>";
								trhtml += "<td>" + json[i].adminID
										+ "</td><td>" + json[i].adminName
										+ "</td><td>" + json[i].role
										+ "</td><td>" + json[i].remark
										+ "</td>";
								...
								trhtml += "<td><a href ='javascript:void(0);' onclick='rowselect("
										+ (i + 1) + ")'>选择</a>&nbsp;&nbsp;";
								trhtml += "<a onclick='tableload()' href='adm/delete?&AdminID="
										+ json[i].adminID
										+ "'>删除</a></td></tr>";
							}
