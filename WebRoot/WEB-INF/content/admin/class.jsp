...
======================================================-->
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="card form" id="form1">
						...
						<br>
						<form id="form" action="cls/add" method="post">
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<label for="exampleInputEmail1">班级编号</label> <input
									...
									<div class="form-group">
										<label for="exampleInputPassword1">班级名称</label> <input
											type="text" class="form-control" name="class.GradeName"
											id="GradeName">
									</div>

									<div class="form-group">
										<label for="exampleInputPassword1">年级名称</label> <input
											type="text" class="form-control" name="class.YearName"
											id="YearName">
									</div>
	...
	<script type="text/javascript">
						...
						success : function(data) {
							...
							for (var i = 0; i < data.length; i++) {
								...
								trhtml += "</td><td><a href='javascript:void(0)' onclick='rowselect("
										+ (i + 1)
										+ ")'>选择</a>&nbsp;&nbsp;<a href='cls/delete?ClassID="
								trhtml += data[i].classID;
								trhtml += "'>删除</a></td></tr>";
							}
		...
		function rowselect(index) {
			...
			$("#GradeName").val(tb.rows[index].cells[2].innerHTML);
			$("#YearName").val(tb.rows[index].cells[3].innerHTML);
			$("#exampleTextarea").val(tb.rows[index].cells[7].innerHTML);
			$("#exampleInputEmail1").attr("readOnly", true);
			form.action = "cls/update";
		}
		function inputreset() {
