...
======================================================-->
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="card form" id="form1">
						...
						<br>
						<form id="form" action="pro/add" method="post">
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<label for="exampleSelect1">所属系部</label> <select
											...
											name="profession.department.DepartmentID" onchange="loaddep()">

										</select>
									</div>
									<div class="form-group">
										<label for="exampleInputEmail1">专业编号</label> <input
									...
									<div class="form-group">
										<label for="exampleInputPassword1">专业名称</label> <input
											type="text" class="form-control" name="profession.ProfessionName"
											id="ProfessionName">
									</div>
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<textarea class="form-control" id="exampleTextarea" rows="2"
											name="profession.Remark"></textarea>
									</div>
	...
	<script type="text/javascript">
						...
						success : function(data) {
							...
							for (var i = 0; i < data.length; i++) {
								...
								trhtml += "</td><td><a href='javascript:void(0)' onclick='rowselect("
										+ (i + 1)
										+ ")'>选择</a>&nbsp;&nbsp;<a href='pro/delete?ProfessionID="
								trhtml += data[i].professionID;
								trhtml += "'>删除</a></td></tr>";
							}
		...
		function rowselect(index) {
			...
			$("#exampleTextarea").val(tb.rows[index].cells[5].innerHTML);
			$("#exampleInputEmail1").attr("readOnly", true);
			form.action = "pro/update";
		}
		function inputreset() {
