			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="card form" id="form1">
						...
						<br>
						<form action="adm/passup" method="post">
							<input type="hidden" value="pwd" id="ad" name="mg">
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group">
										<label for="exampleInputPassword1">原密码</label> <input
											type="text" class="form-control" name="admin.PassWord"
											id="PassWord">
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">新密码</label> <input
											type="text" class="form-control" name="admin.NewPassWord"
											id="NewPassWord">
									</div>
									<div class="form-group">
										<label for="exampleTextarea">确认密码</label> <input
											class="form-control" id="ConPassword" name="admin.ConPassword" />
									</div>
