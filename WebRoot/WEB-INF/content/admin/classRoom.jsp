			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="card form" id="form1">
						...
						<br>
						<form id="form" action="clsr/add" method="post">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleInputEmail1">教室编号</label> <input
											type="text" class="form-control" id="exampleInputEmail1"
											name="classRoom.ID">

									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">教室名称</label> <input
											type="text" class="form-control" name="classRoom.ClassRoomName"
											id="ClassRoomName">
									</div>

									<div class="form-group">
										<label for="exampleInputPassword1">教室类型</label> <input
											type="text" class="form-control" name="classRoom.ClassRoomCategory"
											id="ClassRoomCategory">
									</div>
								</div>
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<textarea class="form-control" id="exampleTextarea" rows="2"
											name="classRoom.Remark"></textarea>
									</div>
					...
					.ajax({
						...
						success : function(data) {
							...
							for (var i = 0; i < data.length; i++) {
								...
								trhtml += "</td><td>";
								trhtml += data[i].classRoomCategory;
								trhtml += "</td><td>";
								trhtml += data[i].remark;
								trhtml += "</td><td>";
								trhtml += "<a href ='javascript:void(0);' onclick='rowselect("
										+ (i + 1) + ")'>选择</a>&nbsp;&nbsp;";
								trhtml += "<a onclick='tableload()' href='clsr/delete?&ID="
