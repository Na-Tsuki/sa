...
======================================================-->
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="card form" id="form1">
						...
						<br>
						<form id="form" action="col/add" method="post">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleInputEmail1">学院编号</label> <input
											type="text" class="form-control" id="exampleInputEmail1"
											name="college.CollegeID">

									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">学院名称</label> <input
											type="text" class="form-control" name="college.CollegeName"
											id="CollegeName">
									</div>
	...
	<script type="text/javascript">
						...
						success : function(json) {
							...
							for (var i = 0; i < json.length; i++) {
								trhtml += "<tr><th scope = 'row'>" + (i + 1)
										+ "</th>";
								trhtml += "<td>" + json[i].collegeID
										+ "</td><td>" + json[i].collegeName
										+ "</td><td>" + json[i].remark
										+ "</td>";

								trhtml += "<td><a href ='javascript:void(0);' onclick='rowselect("
										+ (i + 1) + ")'>选择</a>&nbsp;&nbsp;";
								trhtml += "<a onclick='tableload()' href='col/delete?CollegeID="
										+ json[i].collegeID
										+ "'>删除</a></td></tr>";
							}
		...
		function rowselect(index) {
			...
			$("#exampleTextarea").val(tb.rows[index].cells[3].innerHTML);
			$("#exampleInputEmail1").attr("readOnly", true);
			form.action = "col/update";
		}
		function inputreset() {
