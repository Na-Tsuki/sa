			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="card form" id="form1">
						...
						<br>
						<form id="form" action="aud/add" method=" post">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleInputEmail1">开课编号</label> <input
											type="text" class="form-control" id="exampleInputEmail1"
											name="audit.teachTask.ID" readonly="readonly">

									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">开课教师</label> <input
											type="text" class="form-control" name="audit.teachtask.teacher.TeacherID" id="Teacher"
											readonly="readonly">
									</div>

									<div class="form-group">
										<label for="exampleInputPassword1">课程名称</label> <input
											type="text" class="form-control" name="audit.teachtask.course.CourseID" id="course"
											readonly="readonly">
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">审核状态</label> <select
											class="form-control" name="audit.teachtask.auditing" id="auditing">
											<option>通过</option>
											<option>未通过</option>
										</select>
									</div>
