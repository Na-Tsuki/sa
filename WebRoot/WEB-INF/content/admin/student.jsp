			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="card form" id="form1">
						...
						<br>
						<form id="form" action="stu/add" method="post">
							<div class="row">

								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleSelect1">所属分院</label> <select
											class="form-control" id="colselect" name="collge.CollegeID"
											onchange="loaddeps()">
									...
									<div class="form-group">
										<label for="exampleSelect1">所属系部</label> <select
											class="form-control" id="depselect"
											name="department.DepartmentID" onchange="loadpros()">
									...
									<div class="form-group">
										<label for="exampleSelect1">所属专业</label> <select
											...
											name="profession.ProfessionID" onchange="loadclss()">

										</select>
									</div>

									<div class="form-group">
										<label for="exampleSelect1">所属班级</label> <select
											class="form-control" id="clsselect" name="classs.ClassID"
											onchange="loaddep()">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<label for="exampleInputEmail1">学号</label> <input type="text"
											class="form-control" id="exampleInputEmail1" name="student.StuID">
									...
									<div class="form-group">
										<label for="exampleInputPassword1">性别</label> <select
											class="form-control" id="Sex" name="student.Sex">
											<option>男</option>
											<option>女</option>
										</select>
									...
									<div class="form-group">
										<label for="exampleInputPassword1">生日</label> <input
											...
											id="example-date-input" name="student.Birth">
									</div>
	...
	<script type="text/javascript">
		...
		function loadclss() {
			...
			$.ajax({
				...
				dataType : "json",
				data : {
					"classs.profession.ProfessionID" : id
				},
				success : function(data) {
					$("#clsselect").html("");
					for (var i = 0; i < data.length; i++) {
		...
		function loaddep() {
			var id = $("#clsselect").find("option:selected").val();
			$
					.ajax({
						url : "stu/search",
						type : "post",
